    ...
    <section id="main-content">
      ...
      <?php foreach($tagihan as $tagihan_item) : ?>
        <tr>
          ...
          <td>
            <?php if ($tagihan_item->status == "confirmed" && $tagihan_item->status_terjual == "0"): ?>
            ...
            <?=anchor('admin/tagihan/update_stok/' . $tagihan_item->id_invoice, 'Update Stok', ['class' => 'btn btn-success btn-sm'])?>
