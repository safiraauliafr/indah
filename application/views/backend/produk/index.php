                        ...
                        <table id="<?= $datatable ?>" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Persediaan</th>
                                    <th>Terjual</th>
                                    <th><?= anchor('admin/produk/tambah', '<i class="fa fa-plus" aria-hidden="true"></i> Tambah', ['class' => 'btn btn-primary btn-sm']) ?>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= anchor_popup('produk/lihat/' . $produk_item->id_produk, $produk_item->nama) ?>
                                    </td>
