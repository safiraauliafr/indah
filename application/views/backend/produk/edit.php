                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="namaProduk" name="nama"
                                        ...
                                        placeholder="<?= htmlspecialchars($nama) ?>" required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.1" class="form-control" id="beratProduk"
                                            name="berat" value="<?= $berat ?>" placeholder="Berat" required>
                                        <div class="input-group-addon"><abbr title="kilogram">kg</abbr></div>
                                    </div>
                                </div>
                                <label for="panjangProduk" class="col-sm-2 control-label">Panjang / Lebar /
                                    Tinggi</label>
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.1" class="form-control" id="panjangProduk"
                                            name="panjang" value="<?= $panjang ?>" placeholder="Panjang">
                                ...
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.1" class="form-control" id="lebarProduk"
                                            name="lebar" value="<?= $lebar ?>" placeholder="Lebar">
                                        <div class="input-group-addon"><abbr title="sentimeter">cm</abbr></div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                    <div class="input-group">
                                        <input type="number" min="0" step="0.1" class="form-control" id="tinggiProduk"
                                            name="tinggi" value="<?= $tinggi ?>" placeholder="Tinggi">
                                        <div class="input-group-addon"><abbr title="sentimeter">cm</abbr></div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" min="0" class="form-control" id="persediaanProduk"
                                        name="persediaan" value="<?= $persediaan ?>" placeholder="<?= $persediaan ?>"
                                        required>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" id="deskripsiProduk" name="deskripsi"
                                        placeholder="<?= htmlspecialchars($deskripsi) ?>"
                                        maxlength="255"><?= htmlspecialchars($deskripsi) ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
