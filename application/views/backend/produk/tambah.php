    ...
    <section id="main-content">
      ...
      ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <div class="input-group">
              <input type="number" min="0" step="0.1" class="form-control" id="beratProduk" name="berat" value="<?=set_value('berat')?>" placeholder="Berat" required>
          ...
          <div class="col-sm-2">
            <div class="input-group">
              <input type="number" min="0" step="0.1" class="form-control" id="panjangProduk" name="panjang" value="<?=set_value('panjang')?>" placeholder="Panjang">
              <div class="input-group-addon"><abbr title="sentimeter">cm</abbr></div>
            </div>
          </div>
          <div class="col-sm-2">
            <div class="input-group">
              <input type="number" min="0" step="0.1" class="form-control" id="lebarProduk" name="lebar" value="<?=set_value('lebar')?>" placeholder="Lebar">
              <div class="input-group-addon"><abbr title="sentimeter">cm</abbr></div>
            </div>
          </div>
          <div class="col-sm-2">
            <div class="input-group">
              <input type="number" min="0" step="0.1" class="form-control" id="tinggiProduk" name="tinggi" value="<?=set_value('tinggi')?>" placeholder="Tinggi">
              <div class="input-group-addon"><abbr title="sentimeter">cm</abbr></div>
            </div>
          </div>
        </div>
