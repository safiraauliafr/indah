    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="<?=base_url('assets/backend/img/avatar.png', '')?>" class="img-circle" width="80"></a></p>
          ...
          <div class="col-md-12">
              <h2 class="text-center">Data Pelanggan</h2>
                ...
                <table  class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                  <?php $no=1; foreach($pelanggan as $pelanggan_item) : ?>
                    
                    <tr>
                      <td><?php echo $no++ ."." ?></td>
                      <td><?=$pelanggan_item->nama_depan?></td>
                      <td><?=$pelanggan_item->nama_belakang?></td>
                      <td><?=$pelanggan_item->nama?></td>
                      <td><?=$pelanggan_item->nomor_telepon?></td>
                      <td></td>
                      <td></td>
                      <td></td>
                      <td><?=$pelanggan_item->alamat?></td>
                      <td><?=$pelanggan_item->kode_pos?></td>                      
                      <td>
                        <?=anchor('admin/produk/edit/' . $pelanggan_item->id_pengguna, '<i class="fa fa-cog" aria-hidden="true"></i> Edit', ['class' => 'btn btn-info btn-sm'])?>
                        <?=anchor('admin/produk/hapus/' . $pelanggan_item->id_pengguna, '<i class="fa fa-trash" aria-hidden="true"></i> Hapus',['class' => 'btn btn-danger btn-sm', 'onclick' => 'return promptDelete(' . $pelanggan_item->id_pengguna . ')'])?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                    </tbody>
