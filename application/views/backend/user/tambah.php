        ...
        <aside>
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <?php if ($user1->avatar == ""): ?>
                    <p class="centered"><img class="img-circle" src="<?=base_url('assets/backend/img/avatar.png', '')?>"
                    ...
                    </li> <a class="active" href="<?=base_url('admin/user', '')?>">
        ...
        *********************************************************************************************************************************************************** -->
        ...
        ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" maxlength="64" class="form-control" id="namaBelakang"
                                    name="namabelakang" value="<?=set_value('namabelakang')?>" placeholder="Last Name">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="tel" maxlength="24" class="form-control" id="nomortelepon"
                                    name="nomortelepon" value="<?=set_value('nomortelepon')?>" placeholder="+6281234567"
                                ...
                                <select class="form-control" id="kota" name="kota" required>
                                    ...
                                    $(document).ready(function() {
                                        $("#provinsi").change(function() {
                                            var url =
                                                "<?php echo site_url('admin/user/get_regencies');?>/" +
                                                $(this).val();
                                            $('#kota').load(url);
                                            return false;
                                        });
                                ...
                                <select class="form-control" id="kecamatan" name="kecamatan" required>
                                    ...
                                    $(document).ready(function() {
                                        $("#kota").change(function() {
                                            var url =
                                                "<?php echo site_url('admin/user/get_districts');?>/" +
                                                $(this).val();
                                            $('#kecamatan').load(url);
                                            return false;
                                        });
