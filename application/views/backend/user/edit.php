                ...
                <div id="edit" class="tab-pane">
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                         <form role="form" class="form-horizontal" action="<?php echo base_url('admin/user/perbaharui_profil');?>" class="form-horizontal" method="post">
                        <?php foreach ($user as $user1) :?>
                          <input type="hidden" name="id" value="<?php echo $user1->id_pengguna;?>">
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Depan</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder="Masukkan Nama Depan" id="nama_depan" name="nama_depan" class="form-control" value="<?php echo $user1->nama_depan;?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Belakang</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder="Masukkan Nama Belakang" id="nama_belakang" name="nama_belakang" class="form-control" value="<?php echo $user1->nama_belakang;?>">
                            </div>
                          </div>
                            <div class="form-group">
                            <label class="col-lg-2 control-label">Tanggal Lahir</label>
                            <div class="col-lg-6">
                              <input type="date" placeholder="Masukkan Tanggal Lahir" id="tanggal_lahir" name="tanggal_lahir" class="form-control" value="<?php echo $user1->tanggal_lahir;?>" required>
                            </div>
                          </div>
                            <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <select class="form-control" name="grup" id="grup" required>
                                <option>Grup</option>
                             <option value="1" <?=(($user1->grup == '1') ? 'selected' : '')?>>Pelanggan</option>
                              <option value="2" <?=(($user1->grup == '2') ? 'selected' : '')?>>Admin</option>
                              </select>
                            </div>
                          </div>
                            <div class="form-group">
                      ...
                      <?php endforeach ?>
                            ...
                            <div class="col-lg-6">
                              <input type="number" placeholder="Masukkan Nomor Telepon" id="nomor_telepon" name="nomor_telepon" class="form-control" value="<?php echo $user1->nomor_telepon;?>" required>
                            </div>
                          </div>
                           <div class="form-group">
                                ...
                                <script>
                                    $(document).ready(function(){
                                        $("#provinsi").change(function (){
                                            var url = "<?php echo site_url('admin/akun/get_regencies');?>/"+$(this).val();
                                            $('#kota').load(url);
                                            return false;
                                        });
                                      });
                                ...
                                <script>
                                    $(document).ready(function(){
                                        $("#kota").change(function (){
                                            var url = "<?php echo site_url('admin/akun/get_districts');?>/"+$(this).val();
                                            $('#kecamatan').load(url);
                                            return false;
                                        });
                                      });
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <textarea rows="10" cols="30" class="form-control" id="alamat" name="alamat" required><?php echo $user1->alamat;?></textarea>
                            </div>
                          </div>
                            <div class="form-group">
                            <label class="col-lg-2 control-label">Kode Pos</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder="Masukkan Kode Pos" id="kode_pos" name="kode_pos" class="form-control" value="<?php echo $user1->kode_pos;?>" required>
                            </div>
                          </div>
                          <div class="form-group">
                      ...
                      <form role="form" class="form-horizontal" action="<?php echo base_url('admin/user/update');?>" method="post" class="form-horizontal">
                        <input type="hidden" name="id" value="<?php echo $user1->id_pengguna;?>">
                          <h4 class="mb" style="margin-top: 10px">Informasi Akun</h4>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Email</label>
                            <div class="col-lg-6">
                              <input type="text" placeholder="Masukkan Email anda" id="email" name="email" class="form-control" value="<?php echo $user1->nama;?>" required>
                            </div>
                          </div>
                           <div class="form-group">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="password" placeholder="Masukkan Password Baru" id="new_password" name="newpassword" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Konfirmasi Password Baru</label>
                            <div class="col-lg-6">
                              <input type="password" placeholder="Masukkan Konfirmasi Password Baru" id="confirmpassword" name="confirmpassword" class="form-control"f>
                            </div>
                          </div>
                          <?php endforeach ?>
                           <div class="form-group">
