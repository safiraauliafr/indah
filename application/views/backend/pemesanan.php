          ...
          <div class="col-md-12">
              <h2 class="text-center">Data Pemesanan</h2>
                ...
                <table  class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                  <?php $no=1; foreach($invoice as $invoice_item) : ?>
                  ...
                  <?php if ($invoice_item->status == 'confirmed'): ?>                    
                    <tr>
                      ...
                      <td><button class='btn btn-warning' onclick='lihat_pemesanan($invoice_item->id_invoice)'><i class='glyphicon glyphicon-pencil'></i></button></td>
                    </tr>
                  <?php endif ?>
                  <?php endforeach; ?>
                    </tbody>
