           ...
           <div class="col-lg-12 mt">
                 <div id="edit" class="tab-pane">
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        <h4 class="mb">Edit Profil</h4>
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="file" id="avatar" name="avatar" class="form-control" value="<?php echo $user1->avatar;?>">
                            </div>
                          </div>
                      ...
                      <form role="form" class="form-horizontal" action="<?php echo base_url('admin/akun/perbaharui_akun');?>" class="form-horizontal">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="password" placeholder="Masukkan Konfirmasi Password Baru" id="confirmpassword" name="confirmpassword" class="form-control" required>
                            </div>
                          </div>
                          <?php endforeach ?>
                           <div class="form-group">
