                  ...
                  if ($tagihan->status == 'paid' || $tagihan->status == 'confirmed') {
                    ...
                    ?>
                            <div class="form-group">
                                ...
                                <label class="col-sm-4 control-label">Jasa Pengiriman <p class="help-block"><i
                                            class="fa fa-user-circle-o" aria-hidden="true"></i> Pembeli memilih
                                        <?= $kurirterpilih ?></p> <br>
                                ...
                                <div class="col-sm-8">
                                    <div class="radio">
                                        <label><input type="radio" class="form_control" name="jasapengiriman"
                                                value="JNE"
                                                <?= set_radio('jasapengiriman', 'JNE', ($jasapengiriman == 'JNE')) ?>
                                                required> <abbr
                                                title="PT. Tiki Jalur Nugraha Ekakurir">JNE</abbr></label>
                                    </div>
                                    <div class="radio">
                                        <label><input type="radio" class="form_control" name="jasapengiriman"
                                                value="Tiki"
                                                <?= set_radio('jasapengiriman', 'Tiki', ($jasapengiriman == 'Tiki')) ?>
                                                required> <abbr title="CV. Titipan Kilat">Tiki</abbr></label>
                                    </div>
                                    <div class="radio">
                                        <label><input type="radio" class="form_control" name="jasapengiriman"
                                                value="Pos Indonesia"
                                                <?= set_radio('jasapengiriman', 'Pos Indonesia', ($jasapengiriman == 'Pos Indonesia')) ?>
                                                required> <abbr title="Pos Indonesia">Pos Indonesia</abbr></label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="nomorResi" name="nomorpengiriman" class="form-control"
                                        value="<?= htmlspecialchars($nomorpengiriman) ?>" maxlength="32" required>
                                </div>
                            </div>
                            <div class="col-sm-offset-4 col-sm-8">
                                <div class="btn-group" role="group" aria-label="Kontrol Pengiriman">
                                    <a href="<?= site_url('admin/tagihan/detail/' . $tagihan->id_invoice) ?>"
                                        class="btn btn-default" role="button"><i class="fa fa-chevron-left"
                                            aria-hidden="true"></i> Kembali</a>
                                    <?php
                          if ($tagihan->status == 'confirmed') {
                            ?>
                                    <button type="submit" class="btn btn-success"><i class="fa fa-truck"
                                            aria-hidden="true"></i> Perbarui Informasi Pengiriman</button>
                                    <?php
                          } else {
                            ?>
                                    <button type="submit" class="btn btn-primary"><i class="fa fa-truck"
                                            aria-hidden="true"></i> Tandai Telah Dikirim</button>
                                    <?php
                          }
                          ?>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="inputCekResi" name="noresi"
                                            placeholder="Masukkan nomor resi..."
                                            value="<?= htmlspecialchars($nomorpengiriman) ?>">
                                        <span class="input-group-btn"><button type="submit" class="btn btn-warning"><u
                                                    class="fa fa-external-link" aria-hidden="true"></u> Cek
                                                Resi</button></span>
                                    </div>
                                    <span class="help-block">Disedikaan oleh <a href="https://cekresi.com"
                                            target="_BLANK" rel="nofollow, noopener">cekresi.com</a></span>
                                </div>
                            </div>
                            <?php
                    echo form_close();
