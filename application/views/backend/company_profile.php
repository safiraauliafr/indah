                 ...
                 <div id="edit" class="tab-pane">
                    <div class="row">
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                        ...
                        <form id="form" role="form" class="form-horizontal"  class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/company_profile/update_company');?>">

                      <?php foreach ($company as $company1): ?>
                          <div class="form-group">
                            <div class="col-md-12 text-center">
                              <img class="img-circle" src="<?=base_url('assets/uploads/', '')?><?php echo $company1->logo ;?>">        
                            </div>
                        </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <input type="file" id="logo" name="logo" class="form-control" value="<?php echo $company1->logo ;?>">
                            </div>
                          </div>
                           <div class="form-group">
                            <label class="col-lg-2 control-label">Nama Toko Online</label>
                            <div class="col-lg-8">
                              <input type="text" placeholder="Masukkan Nama Toko Online" id="nama" name="nama" class="form-control" value="<?php echo $company1->nama ;?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">Email</label>
                            <div class="col-lg-8">
                              <input type="text" placeholder="Masukkan Email" id="email" name="email" class="form-control" value="<?php echo $company1->email ;?>">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <select class="form-control" id="sel1" name="id_provinsi">
                                <option value="<?php echo $company1->id_provinsi ;?>"> Pilih Provinsi</option>            
                              </select>   
                            </div>
                            <div class="col-lg-2">
                           ...
                           <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <select class="form-control" id="sel2" name="id_kota" disabled>
                                <option value="<?php echo $company1->id_kota ;?>"> Pilih Kota</option>            
                              </select>     
                              </div>
                              <div class="col-lg-2">
                                <p id="text_kota"></p>                         
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-8">
                              <textarea type="text" placeholder="Masukkan Alamat" id="alamat" name="alamat" class="form-control"><?php echo $company1->alamat ;?></textarea>
                            </div>
                          </div>
                          <?php endforeach ?>
...
var count = 1;
    ...
    function add_dynamic_input_field(count)
  {
    ...
    output += '<div class="form-group" style="margin: 5px;"><div id="rekening2"><div class="col-lg-8"><input type="text" placeholder="BRI - 0123123131 - Atas Nama aaa" id="rekening" name="rekening[]" class="form-control" style="margin-bottom : 10px"> </div><div class="col-lg-1">'+button+'</div></div></div></div>';
