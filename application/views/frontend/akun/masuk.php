		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<div class="input-group">
									...
									<input type="email" maxlength="64" class="form-control" id="namaPengguna" name="nama" value="<?=set_value('nama')?>" placeholder="user@email.com" autofocus required>
								</div>
							</div>
						</div>
						<div class="form-group">
					...
					<p class="lead">Belum bergabung? <?=anchor('akun/daftar', 'Klik disini untuk mendaftar')?>.</p>
					<br>
				</div>
			</div>
			<br>
